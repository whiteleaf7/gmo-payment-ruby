module Gmo
  module Const
    ...
    API_ERROR_MESSAGES_JA = {
      ...
      'GA1000001' => 'あおぞらネットバンクが規制中です。',
      'GA1000002' => 'あおぞらネットバンクがメンテナンス中です。',
      'M01530005' => '入力パラメータエラー/口座名義任意名桁数超過',
      'M01530008' => '入力パラメータエラー/口座名義任意名書式不正',
      'M01531008' => '入力パラメータエラー/取引有効日数書式不正',
      'M01531011' => '入力パラメータエラー/口座名義任意名桁数不正',
      'M01532005' => '入力パラメータエラー/取引事由桁数超過',
      'M01532008' => '入力パラメータエラー/取引事由書式不正',
      'M01533005' => '入力パラメータエラー/振込依頼人氏名桁数超過',
      'M01533008' => '入力パラメータエラー/振込依頼人氏名書式不正',
      'M01534005' => '入力パラメータエラー/振込依頼人メールアドレス桁数超 過',
      'M01534008' => '入力パラメータエラー/振込依頼人メールアドレス書式不 正',
      'M01535002' => '該当する入金履歴がありませんでした。',
      'M01536005' => '入力パラメータエラー/照会期間(開始日)桁数超過',
      'M01536008' => '入力パラメータエラー/照会期間(開始日)書式不正',
      'M01536011' => '入力パラメータエラー/照会期間(開始日)範囲エラー',
      'M01536005' => '入力パラメータエラー/照会期間(終了日)桁数超過',
      'M01536008' => '入力パラメータエラー/照会期間(終了日)書式不正',
      'M01536011' => '入力パラメータエラー/照会期間(終了日)範囲エラー',
      'M01537005' => '入力パラメータエラー/照会期間(終了日)桁数超過',
      'M01537008' => '入力パラメータエラー/照会期間(終了日)書式不正',
      'M01540005' => '入力パラメータエラー/口座名義任意名桁数超過',
      'M01540008' => '入力パラメータエラー/口座名義任意名書式不正',
    }.freeze
